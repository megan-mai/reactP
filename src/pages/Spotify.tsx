...
return(
    ...
    >
       <Project data={test_project as unknown as ProjectData}/>
        
        <ProjectNav></ProjectNav>

        <div id="main" className="pt-[2rem] w-[70%]">

        <SectionTitle title="section 1" setSectionInView={setSectionInView} />
        <Text
        body="Algorithmic reccomendation systems in streaming services prevent users from diversifying their music taste."
        />
        ...
        <p>Self Portrait (2020) is a meditative game inspired by California flora and the excitement of new mediums. In reflecting on process we can connect the dots between influences and the final piece.
        </p>
